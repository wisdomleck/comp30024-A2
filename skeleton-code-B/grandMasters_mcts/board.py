...
class Board:
    ...
    def determine_greedy_moves_both(self, throwsgap=False):
        all_moves = self.generate_turns()
        uppermoves = self.determine_greedy_moves("UPPER", all_moves, throwsgap)
        lowermoves = self.determine_greedy_moves("LOWER", all_moves, throwsgap)
        return uppermoves, lowermoves

    """ determines greedy moves for a single player"""
    def determine_greedy_moves(self, player, all_moves, throwsgap=False):
        moves = []
